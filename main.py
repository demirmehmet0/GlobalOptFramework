...
if params["ALGORITHM"] == "1":
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/bfi.out -lpthread")
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/paar.out -lpthread")
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/rpaar.out -lpthread")
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/bp.out -lpthread")
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/a1.out -lpthread")
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/a2.out -lpthread")
    ...
    os.system("g++ framework-main-2/*.cpp -D FUNCTION=0 -o framework-main-2/rnbp.out -lpthread")
